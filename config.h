...
static Key keys[] = {
	...
	/* G is automatically bound above in STACKEYS */
	...
	/* { MODKEY|ShiftMask,		XK_x,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "sudo install minecraft", NULL } } }, */
	{ MODKEY,			XK_c,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "telegram-desktop", NULL } } },
	/* { MODKEY|ShiftMask,		XK_c,		spawn,		SHCMD("") }, */
	{ MODKEY,			XK_v,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "lfub", NULL } } },
	/* { MODKEY|ShiftMask,		XK_v,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "sudo apt reddit", NULL } } }, */
	{ MODKEY,			XK_b,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "bashtop", NULL } } },
